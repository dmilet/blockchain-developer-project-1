...
class Block {
    ...
    validate() {
        ...
        return new Promise((resolve, reject) => {
            ...
            let blockHeader = {}
            blockHeader['height'] = self.height;
    ...
    getBData() {
        ...
        let self = this;
        return new Promise((resolve, reject) => {
            //console.log("inside getBData() for block height=" + self.height);
            // Genesis block has height = 0
            if (self.height > 0) {
                //console.log("returing block data ");
                resolve(JSON.parse(hex2ascii(self.body)))
            } else {
                reject ("Genesis block - no star data");
            }
